export const mockDevEnvironment = {
  post: [
    {
      tags: {
    ...
    },
    {
      ...
      imgs: [
        ...
        },
        {
          ...
          description:
            'Alinhe a ultimate nessa posição, tem que ser exatamente nessa região para pegar as duas entradas',
      ...
      imgs: [
        {
          ...
          description:
            'Esse spot pega todo o time atacante preparando o entry e pode ser combinado com smokes e varados',
    ...
    },
    {
      ...
      description:
        'Essa ângulo não é esperado pelo time atacante, e você pode abusar dele para conseguir alguns abates',
      user: '61a3ae838fe6df463e7bc1cf',
      imgs: [
        {
    ...
    },
    {
      ...
      imgs: [
        ...
        },
        {
          ...
          description:
            'De um salto para cima (você estará correndo na direção da Erupção das brumas, e então irá pular)',
    ...
    },
    {
      ...
      imgs: [
        ...
        },
        {
          ...
          description:
            'Posicione a barreira em cima da caixa, é interessante que o seu aliado já suba em cima da caixa',
